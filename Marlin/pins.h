...
//julia
    ...
    //#define PAUSE_PIN          64
    #define EMOTOR_ROTATE      59
    #define AMBIENT_TEMP_PIN    9//analog numbering
    #define CHAMBER_FAN_PIN    64
  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define BEEPER 33
      ...
      #define LCD_PINS_D7 29
        ...
        #define BTN_EN1 40  //reverse if the encoder turns the wrong way.
        #define BTN_EN2 42
        #define BTN_ENC 44
        #define LCD_SDSS 53
        #define SDCARDDETECT 66 //49
        #define KILL_PIN 41
