...
#define STRING_CONFIG_H_AUTHOR "Fracktal Works" // Who made the changes.
...
#define TEMP_SENSOR_0 5 //Change to thermistor pt100
#define TEMP_SENSOR_1 5 //Change to thermistor pt100
...
#define EXTRUDE_MINTEMP 150 //150
...
0If it stays longer than _PERIOD, it means the thermistor temperature
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
 ...
 // #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT (240+X_PROBE_OFFSET_FROM_EXTRUDER)    // X point for Z homing when homing all axis (G28)      //hack
...
#define EXTRUDER_OFFSET_X {0.0,0.0} // (in mm) for each extruder, offs et of the hotend on the X axis
...
// Preheat Constants
#define PREHEAT_HOTEND_TEMP 240
